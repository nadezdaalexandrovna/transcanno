Fromthepage::Application.routes.draw do
  ...
  #  resources :document_sets
    ...
    patch 'category/define_description2', :to => 'category#define_description2'
    ...
    patch 'category/define_header_values2', :to => 'category#define_header_values2'
    ...
    patch 'category/import2', :to => 'category#import2'
